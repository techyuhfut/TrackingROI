...
public class GraphicOverlay extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link com.techyu.trackingroi.Camera.GraphicOverlay#add(Graphic)}.
     */
    public static abstract class Graphic {
        private com.techyu.trackingroi.Camera.GraphicOverlay mOverlay;

        public Graphic(com.techyu.trackingroi.Camera.GraphicOverlay overlay) {
            mOverlay = overlay;
        }
