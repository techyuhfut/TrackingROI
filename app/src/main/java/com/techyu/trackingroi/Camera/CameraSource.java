 ...
 * {@link com.techyu.trackingroi.Camera.CameraSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSource {
    ...
    public static class Builder {
        ...
        private final com.techyu.trackingroi.Camera.CameraSource mCameraSource = new com.techyu.trackingroi.Camera.CameraSource();
         ...
         */
        public com.techyu.trackingroi.Camera.CameraSource build() {
            if(usesFaceDetector)
    ...
    public com.techyu.trackingroi.Camera.CameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
